...
{
  "company_overview": {
    "introduction": "根據資料整理出一段約 2-3 句話的公司業務簡介。",
    "industry": "公司所屬的主要產業類別。",
    "key_features": "條列式總結 2-3 點公司的主要特色或競爭優勢。"
  },
  "offerings": {
    "products_services": "條列式總結公司的主要產品或服務項目。"
  },
  "contact_info": {
    "phone": "公司的主要聯絡電話。",
    "address": "公司的主要營業地址。",
    "county": "公司所在地的台灣縣市(必須使用標準選項)。"
        ...
        const flatData = {
            introduction: parsedData.company_overview?.introduction,
            industry: parsedData.company_overview?.industry,
            key_features: parsedData.company_overview?.key_features,
            products_services: parsedData.offerings?.products_services,
